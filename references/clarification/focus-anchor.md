...
- 在长问题、复杂问题、多轮问题里，把主问题、回答范围和分析底稿显性化，防止模型被长材料和戏剧性细节带跑。
...
2. 我这轮是否已经明确只回答 `1` 到 `2` 个问题？
3. 新信息改变的是主问题，还是只是补证据？
4. 我是不是被一个很有戏剧性的细节带偏了？
5. 我现在写的是事实、推断、传闻还是未确认缺口？
6. 这轮结束后，用户能不能一眼看出“我到底答到了哪里”？
